...
RUN apk --no-cache add python python3 py-pip bash zip unzip openjdk8-jre git curl openssh jq ca-certificates \
...
&& mkdir lfs \
&& tar -xvf git-lfs-linux-amd64-v2.8.0.tar.gz -C ./lfs \
